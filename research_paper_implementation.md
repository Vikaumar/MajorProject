...
*   **Risk Velocity Heatmap:** Leverages Plotly's interactive heatmap capabilities (`px.imshow`) to display the temporal evolution of shape/scale velocities and the RVI across all tracked assets, applying divergent color scales for immediate visual anomaly detection.
